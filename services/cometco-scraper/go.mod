module scraping_challenge/services/cometco-scraper

go 1.19

replace scraping_challenge/common => ../../common
...
require (
	...
	scraping_challenge/common v0.0.0-00010101000000-000000000000
)
